...
public class Exam_05 {
	public static void main(String[] args) {
		...
		System.out.println("date1.compareTo(date2) = " + date1.compareTo(date2)); // year => month => day => hour ... 의 순서대로 차이를 리턴
		...
		System.out.println("date4.compareTo(date5) = " + date4.compareTo(date5)); // 4
		System.out.println("date5.compareTo(date4) = " + date5.compareTo(date4)); // -4
