...
public class EmployeeService {
	...
	public void createEmployee(String name, int salary, int salesResut, float rate) {
		Employee employee = new Sales(name, salary, salesResut, rate);
		repository.createOne(employee);
	}
	...
	public void updateEmployee(int idx, String name, int salary, int salesResut, float rate) {
		Employee employee = new Sales(name, salary, salesResut, rate);
		repository.updateOne(idx, employee);
	}
